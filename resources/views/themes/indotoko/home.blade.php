    ...
    <div class="row mt-5">
      <div class="col-lg-3 col-6">
        <div class="card card-body p-lg-4 p3">
          ...
          <h3 class="product-name mt-3">Sepeda BMX</h3>
          <div class="rating">
      ...
      <div class="col-lg-3 col-6">
        <div class="card card-body p-lg-4 p3">
          <a href="#"><img src="img/Sepeda ctb Phonenix.jpg" alt="" class="img-fluid rounded"></a>
          <h3 class="product-name mt-3">Sepeda CTB Ukr 26</h3>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
      ...
      <div class="col-lg-3 col-6 mt-3 mt-lg-0">
        <div class="card card-body p-lg-4 p3">
          ...
          <h3 class="product-name mt-3">Sepeda BMX Ukuran 12</h3>
          <div class="rating">
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
            <i class="bx bxs-star"></i>
...
<div class="col-lg-3 col-6 mt-3 mt-lg-0">
  <div class="card card-body p-lg-4 p3">
    <a href="#"><img src="img/Sepeda ctb Phonenix.jpg" alt="" class="img-fluid rounded"></a>
    <h3 class="product-name mt-3">Sepeda CTB</h3>
    <div class="rating">
      <i class="bx bxs-star"></i>
      <i class="bx bxs-star"></i>
      <i class="bx bxs-star"></i>
...
<div class="col-lg-3 col-6 mt-3 mt-lg-0">
  <div class="card card-body p-lg-4 p3">
    <a href="#"><img src="img/Sepeda mini Phoenix.jpg" alt="" class="img-fluid rounded"></a>
    <h3 class="product-name mt-3">Sepeda mini Phoenix</h3>
    <div class="rating">
      <i class="bx bxs-star"></i>
      <i class="bx bxs-star"></i>
      <i class="bx bxs-star"></i>
